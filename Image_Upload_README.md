...
#### 2. SSH Keys (Client)
**Location**: `C:\Users\svc-dentappsnd-sftp\.ssh\`
...
#### 3. Script Files
**Location**: `C:\Users\myersca\DelphProjects\simlab xray VCL2 2024\VCL2\`

**Files**:
- `upload_image.bat` - Main upload script
- `upload_image copy.bat` - Backup (password-based version)
